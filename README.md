...
latest release, or set it to a release such as `2026.07.25.7` for repeatable
installs.
...
equivalent (`2026.7.25+revision.7`) because SemVer forbids leading zeroes in
