    ...
    >
      ...
      <div className="about__panel">
        <p className="about__lede">
          ...
          host-key decisions never reach a server. Saved hosts are encrypted in this browser under a
          master password and are never sent anywhere.
        </p>
        ...
        <p className="about__star">
          If you find this useful, please consider starring the repository. It helps others discover
          the project.
        </p>
      </div>
    </details>
