...
import { loadTerminalFont } from "./terminalFonts.js";
...
export function App() {
  ...
  useEffect(() => {
    void loadTerminalFont(terminalSettings.fontFamily);
    ...
    <main className={status.kind === "connected" ? "app-shell app-shell--session" : "app-shell"}>
      <header className="app-toolbar">
        ...
        <div className="session-identity">
          <span
            className={`connection-status connection-status--${status.kind}`}
            aria-live="polite"
          >
